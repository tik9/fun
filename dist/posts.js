...
async function handler() {
    ...
    for (var elem of ['posts', 'comments']) {
        var res = (await axios_1.default.get('https://api.stackexchange.com/2.2/users/1705829/' + elem + '?site=stackoverflow&sort=votes&filter=withbody')).data.items.slice(0, 2);
